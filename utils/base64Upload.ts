...
const API_BASE_URL = 'https://api.mentoservices.com/api/v1';
...
export async function uploadImageAsBase64(
  ...
  try {
    ...
    if (Platform.OS === 'web') {
      console.log('Web: Converting to base64...');
      ...
      // For native, you'd use expo-file-system or react-native-fs
      throw new Error('Native base64 upload not implemented');
    }
